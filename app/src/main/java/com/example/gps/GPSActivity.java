...
public class GPSActivity extends AppCompatActivity {
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(GPSActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
        ...
        switch (requestCode) {
            case ACCESS_FINE_LOCATION_INTENT_ID: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(GPSActivity.this, "Location Permission denied.", Toast.LENGTH_SHORT).show();
